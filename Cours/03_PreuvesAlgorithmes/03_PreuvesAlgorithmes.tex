...
\begin{defi}[Correction partielle d'un algorithme]
Un algorithme est dit partiellement correct s'il est correct dès qu'il termine. 

\end{defi}


\begin{defi}[Correction totale d'un algorithme]
Un algorithme est dit totalement correct s'il est partiellement correct et s'il termine. 

\end{defi}



Prouver la correction partielle d'un algorithme signifie montrer que cet algorithme fournit bien la solution au problème qu'il est sensé résoudre. On utilise pour cela un \textbf{invariant de boucle}.
