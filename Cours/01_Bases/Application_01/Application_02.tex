...
\question{\'Ecrire la fonction \lstinline{somme_inverse(n:int)->float} calculant la somme des inverses des \texttt{n} premiers entiers non nuls.}
...
\question{Implémenter la fonction \lstinline{impairs(n:int)} permettant d'afficher la liste des \texttt{n} premiers entiers naturels impairs.}

\question{Implémenter la fonction \lstinline{multiples_5(d:int, f:int)} permettant d'afficher la liste de tous les multiples de 5 compris entre \texttt{d} et \texttt{f} (bornes incluses si se sont des multiples de 5).}
