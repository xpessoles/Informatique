...
\question{Implémenter la fonction \lstinline{prod_vect(u:[float], v:[float])->[float]} permettant calculer le produit vectoriel $\vect{u}\wedge \vect{v}$ dans $\mathbb{R}^3$.}
\ifprof
\begin{corrige}~\\ \vspace{-.5cm}
\begin{lstlisting}
