...
\begin{center}
\includegraphics[width=.95\textwidth]{canalisation}
\end{center}
\end{minipage}
...
\question{} Écrire une fonction Python, appelée $\text{trapeze}$, prenant en argument une fonction \pyv{f}, les variables \pyv{a} et \pyv{b} définissant le domaine d'intégration et le paramètre \pyv{n} définissant le nombre de subdivisions.
