...
\question
%\label{PLT-000:qu:marche} 
%Écrire une fonction \texttt{trace\_marche(m,nom\_de\_fichier)} ne renvoyant rien et enregistrant dans le fichier \texttt{nom\_de\_fichier} le tracé de la marche aléatoire dont les valeurs sont données dans \texttt{m}.

  Vous enverrez à votre enseignant un tracé produit par cette fonction pour $n=500$. 

  \medskip

\question%\label{PLT-000:qu:excursions} 
