...
\question{Implémenter la fonction \lstinline{rotation(chemin, i_piv, a)} qui renvoie un nouveau chemin identique à \lstinline{chemin} jusqu’au pivot d’indice \lstinline{i_piv}, et ayant subi une rotation de \lstinline{a} autour du pivot (même codage que la fonction précédente) sur la partie strictement après le pivot.}
