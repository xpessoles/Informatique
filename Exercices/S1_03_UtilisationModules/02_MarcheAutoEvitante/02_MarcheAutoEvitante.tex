...
\question{En testant la possibilité de réaliser 1000 chemins pour chacune des longueurs comprises entre 1 et 350, tracer la probabilité qu'un chemin échoue en fonction de sa longueur (voir figure \ref{02_CAE_fig_04}).}
