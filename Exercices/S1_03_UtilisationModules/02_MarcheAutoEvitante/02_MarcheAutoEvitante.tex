...
On appelle voisins (ou positions voisines) d'un point, les points situés au-dessus, à droite, au-dessous et à gauche de ce point. Comme dit précédemment, la distance entre 2 points est toujours égale à 1. 
...
\marginnote[1cm]{L'ordre des positions possibles n'est pas important. Attention, pour un chemin à un élément il y a bien \textbf{2 paires} de crochets.}
\begin{test}
