...
\marginnote{L'ordre des voisins n'est pas important.}
\begin{test}
...
\marginnote{L'ordre des positions possibles n'est pas important.}
\begin{test}
...
\question{En testant la possibilté de réaliser 20 chemins pour chacune des longueurs comprises entre 1 et 350, tracer la probabilité qu'un chemin échoue en fonction de sa longueur (voir figure \ref{02_CAE_fig_04}). Une fois votre tracer fonctionnel, on pourra réaliser la courbe pour 200 chemins.}
