\exer{Recherche ddichotomique dans une liste triée}
...
\item  Après la boucle, comme $g\geqd$ (en fait, $g = d$), l’invariant assure que \texttt{x} ne se trouve ni dans \texttt{L[0:g]} ni dans
