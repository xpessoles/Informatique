...
\begin{minipage}{0.5\textwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{images/PPR.jpg}
\caption{\label{PPR}}
\end{center}
\end{minipage}
\end{figure}
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=0.8\textwidth]{images/fichier_gpx.jpg}
\end{center}
\end{figure}
...
\begin{minipage}{0.5\textwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{images/resistance_roulement.png}
...
\begin{minipage}{0.5\textwidth}
\begin{center}
\includegraphics[width=0.9\textwidth]{images/aire_projetee.jpg}
\end{center}
\end{minipage}
\end{figure}
