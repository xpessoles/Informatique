\exer{Appartenance d'un élément à un tableau}

\setcounter{numques}{0}
\question{ \'Etudier les complexité théoriques (dans le pire des cas) des fonctions \texttt{appartient} et \texttt{appartient\_dicho}. Les comparer.}
