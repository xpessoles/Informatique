...
\question{Ecrire la fonction  \texttt{tri\_comptage(L:list,k:int) -> None} permettant de réaliser un tri par comptage avec effet de bord.}

\question{Ecrire la fonction  \texttt{tri\_comptage\_02(L:list,k:int) -> list} permettant de réaliser un tri par comptage sans effet de bord.}
