...
\question{Écrire un script \texttt{Python}{} permettant de lire ce fichier et d'écrire dans un autre fichier, pour chaque nom, le temps en secondes et la vitesse en km/h.}
