...
Dans le cadre cet exercice, les piles sont des \lstinline{deque} importé du module \lstinline{collections}\sidenote{\lstinline{from collections import deque}}.
...
\question{Implémenter la fonction \lstinline{pop_maximum(pile)} renvoyant le maximum des éléments d'une pile d'entiers. La pile initiale sera donc la même à l'exception du maximum le plus haut. Si le maximum apparaît plusieurs fois, on les supprimera tous.}