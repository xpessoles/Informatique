...
\question{Vérifier \texttt{indice\_premier\_PNM(les\_y)} renvoie \texttt{53} et  
...
\question{Vérifier \texttt{indices\_PNM(les\_y)} renvoie \texttt{[53, 449, 889]}.}
...
\question{Tracer chacun des montagnes afin d'obtenir le graphiqu suivant.}
\ifprof
\else
\begin{figure}[H]
\centering
