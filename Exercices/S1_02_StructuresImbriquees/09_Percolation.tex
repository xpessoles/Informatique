...
\marginnote{
On pourra utiliser \lstinline{import random as rd} pour imorter la bibliothèque \lstinline{random}
puis utiliser \lstinline{rd.random()} pour générer un nombre aléatoire.}
}
