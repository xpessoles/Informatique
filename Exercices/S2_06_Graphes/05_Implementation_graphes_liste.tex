...
On considère le graphe \texttt{G} ci-contre. 

\begin{marginfigure}
\includegraphics[width=\linewidth]{05_Implementation_graphes_liste/02_application.png}
\end{marginfigure}
...
\subsubsection*{Dictionnaire d'adjacence}
\question{Reprendre l'ensemble des fonctions précédentes en utilisant un dictionnaire d'adjacence à la place des listes d'adjacence.}
