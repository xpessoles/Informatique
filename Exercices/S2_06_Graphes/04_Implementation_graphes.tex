...
\subsubsection*{Implémentation d'un graphe par une matrice d'adjacence}
...
\question{Écrire la fonction \texttt{ajout\_sommet(G:list, L:list, poids : list) -> None} permettant d'ajouter un sommet au graphe. Cette fonction prendra comme argument \texttt{G} matrice d'adjacence du graphe, \texttt{L} la liste des sommets auxquels le nouveau sommet est relié, \texttt{poids} la liste des poids respectifs. \texttt{ajout\_sommet} agit avec effet de bord sur \texttt{G}.}
