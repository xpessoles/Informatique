...
\def\classe{MPSI}
\def\xxnumpartie{{Exercices}}%\textsf{\textsf{Cy. 4, 6 \& 7}}}
\def\xxpartie{Exercices}


\def\xxnumchapitre{28 avril 2021 \vspace{.2cm}}
\def\xxchapitre{\hspace{.12cm} }


\def\xxtitreexo{\noindent Exercices divers}
...
\def\xxonglet{\textsf{Exercices}}%\textsf{\textsf{Cy. 4, 6 \& 7}}}

\def\xxactivite{\textsf{Exercices}}
...
\begin{enumerate}
\item Écrire une fonction comptage, d’arguments $L$ et $N$, renvoyant une liste $P$ dont le $k$-ième élément désigne le nombre d’occurrences de l’entier $k$ dans la liste $L$.
