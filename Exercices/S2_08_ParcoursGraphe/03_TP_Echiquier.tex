...
\question{\'Ecrire une fonction \texttt{largeur\_dist(G, dep)} qui prend en entrée un graphe codé par un dictionnaire d'adjacence \texttt{G} et un sommet de départ \texttt{dep} et renvoie un dictionnaire de distances à partir du sommet \texttt{dep}. Si un sommet n'est pas atteignable depuis le depuis \texttt{dep}, la valeur associée doit être de \texttt{-1}.}
