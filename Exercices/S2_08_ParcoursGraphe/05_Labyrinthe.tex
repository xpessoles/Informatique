...
\question{Écrire la fonction \cde{creer\_graphe(n:int, p:int) -> \{\}} permettant de créer une grille de \cde{} lignes et \cde{p} colonnes. }

\question{En utilisant la fonction \cde{tracer\_graphe(G)}, vérifier que votre graphe a la bonne structure.}
