...
\usepackage[%
    pdftitle={Projet Informatique : Modélisation des lois de déplacement d'un solide en 3 axes},
...
\def\xxtitreexo{Modélisation des lois de déplacement d'un solide en 3 axes}
