...
Puissances de 2 : \textit{Comment évaluer le nombre 2 à la puissance $n$ de manière explicite, $n\in \mathbb{N}$ ?} On définit de manière explicite la suite :  $u_n=2^n$.
\end{minipage}\hfill
...
\subsection{Notions de piles d'exécution}
