...
\hline 
{Pire des cas} &  Liste triée à l'envers & Liste triée$^1$ & \\ 
...
Meilleur des cas  & Liste triée & Liste triée$^2$ & \\ 
  & $ C(n)=\mathcal{O}\left(n \right)$ & $ C(n)=\mathcal{O}\left(n \right)$ & $ C(n)=\mathcal{O}\left(n \log n\right)$ \\ \hline
\end{tabular}
\end{center}

\footnotesize{1 : lorsque le pivot est la dernière valeur des listes.}

\footnotesize{2 : lorsque le pivot est pris au milieu des listes.}
