...
Pour télécharger le fichier \textsf{Rhune.py} avec Python, saisir les lignes suivantes :
...
\subparagraph{}
\textit{Réaliser la fonction \textsf{Affiche\_n} qui permet d'afficher les n premières lignes du fichier \textsf{Rhune.kml}. Expliquer pourquoi une ligne vide sépare chacune des lignes.}
...
\subparagraph{}
\textit{Réaliser la fonction permettant de savoir si le caractère \textsf{w} est compris dans une ligne de texte.}
