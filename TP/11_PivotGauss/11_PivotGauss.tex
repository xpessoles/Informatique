...
\subparagraph{}
\textit{Écrire une procédure \quad\texttt{transv(M,i,mu,j)}\quad qui remplace  la ligne n°\texttt{i}, L$_{\texttt{i}}$, par :}

\hfil L$_{\texttt{i}}$ $\longleftarrow$\quad L$_{\texttt{i}}$ + \texttt{mu}$\times$L$_{\texttt{j}}$
