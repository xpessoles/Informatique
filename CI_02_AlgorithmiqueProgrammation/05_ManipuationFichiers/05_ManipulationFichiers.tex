...
\textsc{Savoirs :}
\begin{itemize}
\item **%'interroger sur l'efficacité algorithmique temporelle.
\end{itemize}
\end{savoir}
...
Avantages &  Moins volumineux & Interprétables par l'homme\\
		  ...
		  & Indépendants des standards d'encodage des caractères dans les OS &Permettent des d'échanges plus simples entre logiciels\\
