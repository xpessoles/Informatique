...
\ifprof
\begin{corrige}
Pour rechercher un minimum dans une liste de liste, il faut rechercher le minimum dans chacune des sous-listes. Pour cela, on peut, par exemple, avoir recours à deux boucles imbriquées.
\end{corrige}
\else
\begin{center}
\begin{tabular}{|p{.95\linewidth}|}
