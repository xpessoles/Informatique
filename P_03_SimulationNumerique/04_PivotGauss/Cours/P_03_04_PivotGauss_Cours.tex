...
\usepackage[%
    pdftitle={Informatique : Pivot de Gauss},
...
\def\xxchapitre{\hspace{.12cm} Résolution d'un système linéaire inversible par la méthode de Gauss}

\def\xxposongletx{2}
\def\xxposonglettext{1.45}
\def\xxposonglety{19}%16

\def\xxonglet{Part. 3 -- Ch. 4}
...
\item Problème discret multidimensionnel, linéaire, conduisant à la résolution d’un système linéaire inversible (ou de Cramer) par la méthode de Gauss avec recherche partielle du pivot.
\end{itemize}
}}
...
Ch 4 : Pivot de Gauss -- \xxactivite%
}
