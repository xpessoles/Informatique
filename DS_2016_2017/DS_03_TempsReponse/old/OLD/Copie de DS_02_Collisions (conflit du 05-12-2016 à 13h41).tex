...
\subparagraph{}
\textit{Écrire une fonction \texttt{attendreCollision(particules, tMax)} qui prend un ensemble de particules et un temps \texttt{tMax} en paramètres et renvoie le temps ou a eu lieu la premiere collision entre
deux particules. S'il n'y a pas de collision avant le temps tMax, la fonction renvoie None. Quelle
est sa complexite, en fonction du nombre n de particules et de tMax ? La reponse devra ^etre
justiee.}
