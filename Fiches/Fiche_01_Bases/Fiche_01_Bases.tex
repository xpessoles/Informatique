...
\begin{defi} \textbf{\textsf{\small Valeurs -- }}
...
\begin{defi}\textbf{\textsf{\small Expression -- }}
...
\begin{defi}\textbf{\textsf{\small \small Variable -- }}
...
\begin{defi}\textbf{\textsf{\small Entiers -- }}
...
\begin{defi}\textbf{\textsf{\small Flottants -- }}
...
\begin{defi}\textbf{\textsf{\small Expression -- Booléen}}
...
\begin{defi}\textbf{\textsf{\small Tuple --}}
...
\begin{defi}\textbf{\textsf{\small Chaînes de caractères --}}
...
\end{defi}
\subsection{Listes}
\begin{defi}\textbf{\textsf{\small Listes --}}
...
On peut signaler une tabulation par \texttt{\\t} et créer une nouvelle ligne par \texttt{\\n}.
