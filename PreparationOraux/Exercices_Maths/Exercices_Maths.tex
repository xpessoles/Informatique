...
\addcontentsline{toc}{subsection}{Exercice 20 -- Courbe de Peano}
...
\addcontentsline{toc}{subsection}{Exercice 21 -- Flocon de Koch}
...
\addcontentsline{toc}{subsection}{Exercice 22 -- Intégration numérique}
...
\addcontentsline{toc}{subsection}{Exercice 23 -- Équation différentielle}
...
\addcontentsline{toc}{subsection}{Exercice 23 -- Suite de Fibonacci}
...
\addcontentsline{toc}{subsection}{Exercice 24 -- Produits de matrices}
...
\addcontentsline{toc}{subsection}{Exercice 25 -- Équations différentielles}
...
\addcontentsline{toc}{subsection}{Exercice 26 -- Équations des ondes}
...
\addcontentsline{toc}{subsection}{Exercice 27 -- Position d'une membrane}
...
\addcontentsline{toc}{subsection}{Exercice 28 -- Polygones orthogonaux}
...
\addcontentsline{toc}{subsection}{Exercice 29 -- Système proies -- prédateurs}
...
\addcontentsline{toc}{subsection}{Exercice 30 -- Transformée de Fourier}
...
\addcontentsline{toc}{subsection}{Exercice 31}
...
\addcontentsline{toc}{subsection}{Exercice 32 -- Débruitage d'un signal}
...
\end{enumerate}
\addcontentsline{toc}{subsection}{Exercice 33 -- Taches solaires}
...
\addcontentsline{toc}{subsection}{Exercice 34 -- Traitement d'image -- Filtre}
...
\addcontentsline{toc}{subsection}{Exercice 13 -- Corrigé}
...
\columnbreak
\addcontentsline{toc}{subsection}{Exercice 15 -- Corrigé}
...
\columnbreak
\addcontentsline{toc}{subsection}{Exercice 18 -- Corrigé}
...
\columnbreak
\addcontentsline{toc}{subsection}{Exercice 22 -- Corrigé}
\subsection*{Exercice 22 -- Corrigé}
