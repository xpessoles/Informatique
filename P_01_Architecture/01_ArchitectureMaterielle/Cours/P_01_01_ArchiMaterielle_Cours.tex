...
\usepackage[%
    pdftitle={Informatique : Architecture matérielle},
...
\def\xxchapitre{\hspace{.12cm} Architecture matérielle}

\def\xxposongletx{2}
\def\xxposonglettext{1.45}
\def\xxposonglety{25}%22
\def\xxonglet{Part. 1 -- Ch. 1}
...
\item Dec - C1 : se familiariser aux principaux composants d’une machine numérique telle que l’ordinateur personnel, une tablette, etc : sources d’énergie, mémoire vive, mémoire de masse, unité centrale, périphériques d’entrée-sortie, ports de communication avec d’autres composants numériques.
\end{itemize}
}}

\def\xxfigures{
\begin{center}
\includegraphics[width=.95\textwidth]{images/pascaline.png}

\textit{Pascaline -- 1652}
\end{center}

%\begin{center}
%\includegraphics[width=.95\textwidth]{images/eniac.png}
%
%\textit{ENIAC -- 1946}
%\end{center}
%
%\begin{center}
%\includegraphics[width=.95\textwidth]{images/macintosh_p.png}
%
%\textit{Macintosh -- 1984}
%\end{center}

\begin{center}
\includegraphics[width=.95\textwidth]{images/macbook.png}
...
Ch 1 : Architecture matérielle -- \xxactivite%
}
...
\begin{center}
\includegraphics[width=.7\textwidth]{images/carte_mere_2.png}
\end{center}
...
\begin{center}
\includegraphics[width=.8\textwidth]{images/cpu_amd_p.png}
\includegraphics[width=.8\textwidth]{images/cpu_intel.png}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=.85\textwidth]{images/archi_cpu}
\end{center}
...
\begin{minipage}[c]{.3\linewidth}
\begin{center}
\includegraphics[width=.7\textwidth]{images/dd_1_p.png}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=.9\textwidth]{images/dd_comp.png}
\end{center}
\end{minipage} 
...
\begin{minipage}[c]{.3\linewidth}
\begin{center}
\includegraphics[width=.9\textwidth]{images/ram.png}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=\textwidth]{images/usb.png}
\end{center}
\end{minipage}
...
\begin{minipage}[c]{.2\linewidth}
\begin{center}
\includegraphics[width=\textwidth]{images/ps2.png}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=.9\textwidth]{images/ethernet.png}
\end{center}
\end{minipage}\hfill
...
\begin{center}
\includegraphics[width=.9\linewidth]{images/vga}
\end{center}
\end{minipage}
...
\begin{minipage}[c]{.14\linewidth}
\begin{center}
\includegraphics[width=.9\linewidth]{images/dvi}
\end{center}
\end{minipage}
...
\begin{minipage}[c]{.14\linewidth}
\begin{center}
\includegraphics[width=.9\linewidth]{images/hdmi}
\end{center}
\end{minipage}
