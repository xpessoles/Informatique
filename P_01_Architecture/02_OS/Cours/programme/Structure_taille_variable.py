...
# Tracé des pivots et des efforts extérieurs
...
print('A triagularisee',A,b, A.round(2))
...
color=(0.8, 0.8, 0.8)
# Échelle pour le tracé des forces
F_scale = 0.9*barre_l.mean()/solution.max()
# Couleur des efforts:
F_color = (0., 0, 1) # bleu
dx, dy  = 1,2
