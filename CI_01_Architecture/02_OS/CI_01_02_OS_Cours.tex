...
\usepackage[%
    ...
    pdfauthor={Damien Iceta Xavier Pessoles},
    colorlinks=true,
    linkcolor=blue,
...
\begin{minipage}[c]{.15\linewidth}
\begin{center}
\includegraphics[height=.8cm]{png/ios7}
\end{center}
\end{minipage}\hfill
\begin{minipage}[c]{.15\linewidth}
\begin{center}
\includegraphics[height=1.4cm]{png/osx}
\end{center}
\end{minipage}\hfill
\begin{minipage}[c]{.15\linewidth}
\begin{center}
\includegraphics[height=2cm]{png/gentoo}
\end{center}
\end{minipage}\hfill
\begin{minipage}[c]{.15\linewidth}
\begin{center}
\includegraphics[height=2cm]{png/android}
\end{center}
\end{minipage}\hfill
\begin{minipage}[c]{.15\linewidth}
\begin{center}
...
%\begin{Objectif}
%
%\textsc{L'objectif est ici de se familiariser (Savoir Dec - C1):}
%
%\begin{itemize}
%\item à la manipulation d’un système d’exploitation (gestion des ressources, essentiellement : organisation des fichiers, arborescence, droits d’accès, de modification, entrées/sorties);
%\item à la manipulation d’un environnement de développement.
%\end{itemize}
%
%\textsc{La principale capacité développée est :}
%\begin{itemize}
%\item manipuler en mode « utilisateur » les principales fonctions d’un système d’exploitation et d’un environnement de développement.
%\end{itemize}
%\end{Objectif}
