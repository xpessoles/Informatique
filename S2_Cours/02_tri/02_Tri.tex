...
\begin{defi}\small{\textsf{\textbf{Effet de bord }}}--  On dit qu'une fonction est à effet de bord lorsqu'elle modifie une variable  en dehors de son environnement local. C'est par exemple le cas lorsqu'on donne une liste (objet mutable, passé par référénce) comme argument d'une fonction.
...
\begin{exemple2}[tri d'avis sur un site marchand]
...
\begin{defi}\small{\textbf{\textsf{Notions de complexité}}}~\\
...
%
%
%\begin{definition2}[Application de la complexité dans le cas d'algorithme de tri]
%\begin{itemize}
...
%\end{definition2}
%
%\begin{exemple2}[Choix du type de complexité pour le tri d'avis sur un site marchand]
%
...
%
%\begin{definition2}[Tri comparatif]
%
...
%
%
%\begin{exemple2}[Algorithme de tri de trois données a, b, c]
%
...
\begin{exemple2}[Illustration du tri par insertion]

On représente en rouge les valeurs triées.
La clef est en bleu. Les données décalées sont en vert.


\noindent\begin{tabular}{|p{11.5cm}|c|c|c|c|}
\hline \rowcolor{white}
\hline
Tableau $T$ initial: 5 est la clef. & \cellcolor{bleuc}5 & 14 & 11 & 8 \\ 
\hline 
\hline \rowcolor{white}
La clef est comparée avec la liste des valeurs déjà triées (vide ici). & \cellcolor{rougec}5 & 14 & 11 & 8   \\ 
\hline 
\hline \rowcolor{white}
 La clef est 14 & \cellcolor{rougec}5 & \cellcolor{bleuc}14 & 11 & 8  \\ 
\hline 
\hline \rowcolor{white}
On compare la clef aux valeurs déjà triées (ici 5). Elle est plus grande et reste donc à sa position. & \cellcolor{rougec}5 & \cellcolor{rougec}14 & 11 & 8  \\ 
\hline 
\hline \rowcolor{white}
 La clef est 11. & \cellcolor{rougec}5 & \cellcolor{rougec}14 & \cellcolor{bleuc}11 & 8  \\ 
\hline 
\hline \rowcolor{white}
On compare la clef aux valeurs déjà triées : la première valeur comparée est 14. 14 est plus grand donc on décale 14 vers la droite pour laisser une place à la clef. & \cellcolor{rougec}5 & \cellcolor{vertc}14 & \cellcolor{vertc}14 & 8 \\ 
\hline 
\hline \rowcolor{white}
On compare la clef aux valeurs déjà triées : la valeur suivante est 5. 5 est plus petit donc on a trouvé la place de la clef et on l'écrit. & \cellcolor{rougec}5 & \cellcolor{rougec}11 & \cellcolor{rougec}14 & 8  \\ 
\hline 
\hline \rowcolor{white}
La clef est 8. & \cellcolor{rougec}5 & \cellcolor{rougec}11 & \cellcolor{rougec}14 & \cellcolor{bleuc}8  \\ 
\hline 
\hline \rowcolor{white}
On compare la clef 8 à 14. 14 est plus grand donc on le décale en le copiant à la place de la clef. & \cellcolor{rougec}5 & \cellcolor{rougec}11 & \cellcolor{vertc}14 & \cellcolor{vertc}14  \\ 
\hline 
\hline \rowcolor{white}
On compare la clef 8 à 11. 11 est plus grand donc on le décale en le copiant à la place de la valeur supérieure (on écrase donc une des occurrences de 14). & \cellcolor{rougec}5 & \cellcolor{vertc}11 & \cellcolor{vertc}11 & \cellcolor{rougec}14  \\ 
\hline 
\hline \rowcolor{white}
On compare la clef  8 à 5. 5 est plus petit donc on est à la bonne place pour copier la clef (on écrase donc l'occurrence de 11 en doublon). & \cellcolor{rougec}5 & \cellcolor{rougec}8 & \cellcolor{rougec}11 & \cellcolor{rougec}14  \\ 
\hline 
\end{tabular} 
...
\begin{center}
		\lstinputlisting{programmes/tri_insertion.py}
\end{center}

\end{algorithme}

\begin{exemple2}[Application avec affichage pas a pas sur l'exemple]
...
\hline\hline
\rowcolor{white}
 & \cellcolor{vertc}5  & &  &\cellcolor{vertc} 14&\cellcolor{vertc} 14&  \cellcolor{vertc} 17 \\
 \cline{2-3} \rowcolor{white}
...
\hline\hline
\rowcolor{white}
 & \cellcolor{vertc}5  & \cellcolor{vertc}7 &\cellcolor{vertc} 8  &\cellcolor{vertc} 14&\cellcolor{vertc} 14&  \cellcolor{vertc} 17 \\
 \cline{2-3} \rowcolor{white}
...
%\begin{center}
%		\lstinputlisting{./programmes/fusion.py}
%\end{center}
