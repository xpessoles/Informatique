...
\subsubsection{Complexité du tri fusion -- Petites remarques}
%
%Quel est le coût de l'algorithme de fusion précédent ?
%
%La première question à se poser est le coût de la concaténation 
