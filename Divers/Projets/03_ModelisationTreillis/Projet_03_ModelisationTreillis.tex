...
\usepackage[%
    pdftitle={Projet Informatique : Modélisation des treillis},
...
\def\xxtitreexo{Modélisation d'un treillis}
\def\xxsourceexo{D'après ressources de D. Iceta.}%\hspace{.2cm} D'après concours Mines-Ponts -- 2013.}
